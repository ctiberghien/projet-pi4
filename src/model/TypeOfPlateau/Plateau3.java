...
public class Plateau3 extends Plateau {
    ...
    public Plateau3(Joueur j1, Joueur j2) {
        ...
        this.addTuile(new Coordonnee(3, 0), new Tuile(0));
        ...
        this.addTuile(new Coordonnee(6, 0), new Tuile(1));

         tmp = Plateau.getRandNextCoord(new Coordonnee(6, 0));
