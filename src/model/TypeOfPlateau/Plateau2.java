...
public class Plateau2 extends Plateau {
    ...
    public Plateau2(Joueur j1, Joueur j2) {
        ...
        this.j1 = j1;
        this.j2 = j2;
        this.addTuile(new Coordonnee(0, 0), new Tuile(0));
        this.addTuile(new Coordonnee(2, -2), new Tuile(0));
        this.addTuile(new Coordonnee(4, -3), new Tuile(0));
        this.addTuile(new Coordonnee(6, -3), new Tuile(0));
        this.addTuile(new Coordonnee(7, -2), new Tuile(0));
        this.addTuile(new Coordonnee(7, 0), new Tuile(0));
        this.addTuile(new Coordonnee(6, 2), new Tuile(0));
        this.addTuile(new Coordonnee(4, 4), new Tuile(0));
        this.addTuile(new Coordonnee(-1, 2), new Tuile(0));
        this.addTuile(new Coordonnee(0, 5), new Tuile(0));
        this.addTuile(new Coordonnee(-1, 4), new Tuile(0));
        this.addTuile(new Coordonnee(0, 5), new Tuile(0));
        this.addTuile(new Coordonnee(2, 5), new Tuile(0));
        this.addTuile(new Coordonnee(1, 1), new Tuile(0));
        this.addTuile(new Coordonnee(3, 1), new Tuile(0));
        this.addTuile(new Coordonnee(2, 3), new Tuile(0));
        this.addTuile(new Coordonnee(5, 1), new Tuile(0));
        this.addTuile(new Coordonnee(4, -1), new Tuile(0));
        this.addTuile(new Coordonnee(8, 1), new Tuile(2));
        LinkedList<Coordonnee> tmp = new LinkedList<>();
        tmp.add(new Coordonnee(-2, 2));
        tmp.add(new Coordonnee(-1, 1));
        tmp.add(new Coordonnee(-1, 0));
        this.addTuile(new Coordonnee(-2, 1), new Tuile(1));
        ...
        tmp.clear();
        tmp.add(new Coordonnee(7, 2));
        tmp.add(new Coordonnee(8, 0));
        tmp.add(new Coordonnee(7, 1));
